...
if (isset($_GET["logout"]) && $_GET["logout"] === "true") {
    ...
    // The navbar links straight to this controller, so at this moment
    // the browser's address is /controllers/... . A plain "login.php"
    // would therefore point at /controllers/login.php, which does not
    // exist - the login page lives in /views/.
